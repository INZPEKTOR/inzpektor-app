 ...
 * 
 * @param {string} title - Main title (e.g., "INZPEKTOR ID")
 * @param {string} subtitle - Subtitle below title (e.g., "V.1.0")
 * @param {string} statusText - Center status text (e.g., "PROOF OF CLEAN HANDS VERIFIED")
 * @param {string} wallet - Wallet address (e.g., "emmilll.eth")
 * @param {string} label - Bottom right label (e.g., "MINTED")
 * @param {string} date - Date text (e.g., "2024.07.26")
 * @param {React.ReactNode} icon - Optional custom icon component
 */
const InspektorScoreCard = ({
  title = "INZPEKTOR ID",
  subtitle = "V.1.0",
    ...
    <div className="w-full flex justify-center px-4 sm:px-6 lg:px-8">
      <div 
        ...
        style={{
          ...
          boxShadow: '0 0 40px rgba(50, 255, 149, 0.4)',
          border: '1px solid rgba(50, 255, 149, 0.2)'
        }}
      >
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle at 30% 30%, rgba(50, 255, 149, 0.1) 0%, transparent 50%)'
          }}
        />
